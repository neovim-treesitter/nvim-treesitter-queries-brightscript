# nvim-treesitter-queries-brightscript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-brightscript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-brightscript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **brightscript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-brightscript",
...
- [ ] Changes are scoped to `brightscript` — do not include files for other languages
